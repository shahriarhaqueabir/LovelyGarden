...
export const OBSERVATION_PATTERNS: ObservationPattern[] = [
  // MOISTURE
  {
    ...
    diagnostic:
      "Critical loss of turgor pressure due to severe dehydration or high transpiration.",
    prescription:
      "Provide a deep, slow soak at the base immediately. Apply mulch to retain moisture.",
  ...
  },
  {
    ...
    diagnostic:
      "Anaerobic conditions at the root zone (Root Rot). Oxygen is being blocked by excess water.",
    prescription:
      "Cease watering immediately. Aerate the soil surface and ensure drainage holes are clear.",
  ...
  // FERTILITY (Indicator Weeds)
  {
    ...
    diagnostic:
      "Indicators of high nitrogen and phosphorus availability in the soil.",
    prescription:
      "Soil is currently nitrogen-rich. Avoid adding nitrogen-heavy fertilizer for now.",
    impact: { n: 85, p: 70 },
  },
  {
    ...
    diagnostic:
      "Thrives in well-drained, sandy, and nitrogen-poor (lean) alkaline soil.",
    prescription:
      "Consider supplementing with organic compost or blood meal to boost nitrogen levels.",
    impact: { n: 25, k: 40 },
  },
  ...
  // PESTS & DISEASE
  {
    ...
    diagnostic:
      "Aphid colony sucking plant sap and excreting honeydew (attracts ants/sooty mold).",
    prescription:
      "Spray with neem oil or a strong stream of water. Introduce ladybugs as natural predators.",
    impact: { stress: 25 },
  },
  {
    id: "obs_pest_fungal",
    ...
    prescription:
      "Improve spacing. Prune affected leaves. Use an organic milk/baking soda spray.",
    impact: { stress: 35 },
  },
  ...
  // NUTRIENTS
  {
    ...
    diagnostic:
      "Phosphorus (P) deficiency. Common in cold soils where P-uptake is limited.",
    prescription:
      "Apply rock phosphate or bone meal. Check soil pH as acidity can lock out phosphorus.",
  ...
  },
  {
    ...
    diagnostic:
      "Potassium (K) deficiency. Affects the plant's ability to regulate water and resist disease.",
    prescription:
      "Apply wood ash or kelp meal. Ensure consistent watering as K is mobile in water.",
  ...
  // GROWTH PROGRESS
  {
    ...
    diagnostic:
      "General stress or resource depletion. Likely insufficient light or root binding.",
    prescription:
      'Evaluate sun exposure. Consider a liquid "booster" feeding (seaweed extract).',
    impact: { stress: 20 },
  },
  {
    id: "obs_growth_leggy",
    ...
    diagnostic:
      "Etiolation. The plant is searching for light, sacrificing structural integrity for height.",
    prescription:
      "Move to a brighter location or add supplemental lighting immediately.",
    impact: { stress: 15 },
  },
];

export const getExtendedObservations = (plantCatalog?: {
  common_pests?: string[];
...
export const getDiagnosticByObservationId = (
  id: string,
  plantCatalog?: { common_pests?: string[]; common_diseases?: string[] },
