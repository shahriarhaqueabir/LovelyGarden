...
export const LogbookTab: React.FC = () => {
  ...
  const [formData, setFormData] =
    useState<LogbookFormState>(INITIAL_FORM_STATE);
      ...
      <header className="p-8 border-b border-stone-800 bg-stone-900/30 backdrop-blur-md flex justify-between items-center">
        <div>
          ...
          <p className="text-stone-500 text-sm mt-1 uppercase tracking-widest font-bold">
            Chronicle of Acquisitions & Investments
          </p>
        </div>
        <button
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-1 flex-wrap">
                        ...
                        <span
                          className={`text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded border ${
                            entry.type === "seed_purchase"
                              ? "border-garden-500/20 text-garden-400 bg-garden-500/5"
                              : entry.type === "planting"
                      ...
                      {entry.notes && (
                        <p className="text-xs text-stone-400 mt-3 italic border-l-2 border-stone-800 pl-3">
                          "{entry.notes}"
                        </p>
                      )}
                    </div>
