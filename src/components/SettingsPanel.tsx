...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({ onClose }) => {
  ...
  const handleClearCache = () => {
    if (
      confirm(
        "Clear local application cache? This will reset theme and local preferences but keep your garden data.",
      )
    ) {
      localStorage.clear();
        ...
        <div className="p-6 space-y-8 overflow-y-auto custom-scrollbar">
          ...
          <section className="space-y-4">
            ...
            <div className="pt-2">
              ...
              {importStatus && (
                <p
                  className={`text-center text-[10px] mt-2 font-bold ${importStatus.includes("success") ? "text-garden-500" : "text-stone-500"}`}
                >
                  {importStatus}
                </p>
              )}
          ...
          <section className="space-y-4 pt-4 border-t border-red-900/30">
            <div className="flex items-center gap-2 text-red-900/50 pb-2 border-b border-red-900/20">
              ...
              <h3 className="text-xs uppercase font-bold tracking-widest text-red-900/50">
                Danger Zone
              </h3>
            </div>
