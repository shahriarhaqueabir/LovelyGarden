...
export const GardenConfigDialog: React.FC<GardenConfigDialogProps> = ({
  onClose,
  onSave,
  initialConfig,
  mode,
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase text-stone-500 tracking-widest">
                  Designation
                </label>
                <input
                  {...register("name")}
              ...
              <div className="space-y-3 pt-2 border-t border-stone-800/50">
                ...
                {mode === "edit" && !isGardenEmpty && (
                  <div className="bg-amber-900/10 border border-amber-900/30 rounded p-2 text-[10px] text-amber-500/80 mb-2">
                    ⚠️ Grid dimensions are fixed while plants are present to
